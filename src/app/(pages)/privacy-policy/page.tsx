export default function PrivacyPolicy() {
  return (
    <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
      <p>Effective Date: Wed 14 May 2024</p>
      <p>
        At PK ToolsCloud, we are committed to safeguarding your privacy. This
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          data we collect, please contact us at pankajyadav91224@gmail.com.
        </p>
      </div>

      <p>
        By using PK ToolsCloud, you agree to the practices outlined in this
