...
export default function About() {
  return (
    <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
      <p>
        Welcome to PK ToolsCloud, the ultimate multimedia conversion powerhouse
      ...
      <div className="space-y-2">
        ...
        <p>
          Access PK ToolsCloud from any device with an internet connection.
          Whether you&apos;re on your computer, tablet, or smartphone, you can
          use our platform with ease.
        </p>
      </div>
      ...
      <div className="space-y-2">
        <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">
          🌟 It&apos;s Free, It&apos;s Powerful, It&apos;s PK ToolsCloud:
        </h2>
        <p>
