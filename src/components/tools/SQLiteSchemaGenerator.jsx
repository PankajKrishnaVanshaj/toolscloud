// components/SQLiteSchemaGenerator.jsx
'use client'
    ...
    try {
      ...
      tables.forEach(table => {
        ...
        const columnDefs = table.columns.map(col => {
          ...
          if (!col.isNullable && !col.isPrimary) def += ' NOT NULL' // PRIMARY KEY implies NOT NULL in SQLite
  ...
  const addTable = () => {
    if (tables.length < MAX_TABLES) {
      setTables([...tables, {
        ...
        columns: [{ name: 'id', type: 'INTEGER', isPrimary: true, isNullable: false, isUnique: true, autoIncrement: true, defaultValue: '' }],
      }])
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-lg p-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">SQLite Schema Generator</h1>
