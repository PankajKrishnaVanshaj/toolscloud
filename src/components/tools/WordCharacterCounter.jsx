...
import { FaCopy, FaTrash, FaDownload, FaChartBar } from "react-icons/fa";
      ...
      <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl w-full ">
        ...
        <div className="mt-6 p-4 bg-blue-100 rounded-lg border border-blue-300">
          ...
          <ul className="list-disc list-inside text-blue-600 text-sm">
            ...
            <li>
              Estimates reading/speaking time and readability (Flesch Score)
            </li>
            <li>
              Customizable counting with case, punctuation, and delimiters
            </li>
