  ...
  const [tables, setTables] = useState([
    {
      ...
      columns: [
        ...
        { name: 'email', type: 'text', isPrimary: false, isNullable: false, isUnique: true, defaultValue: '' },
  ...
  const generateSchema = useCallback(() => {
    ...
    try {
      ...
      tables.forEach(table => {
        ...
        schemaString += `ALTER TABLE ${table.name} ENABLE ROW LEVEL SECURITY;\n\n`
      })
  ...
  const addTable = () => {
    if (tables.length < MAX_TABLES) {
      setTables([...tables, {
        ...
        columns: [{ name: 'id', type: 'uuid', isPrimary: true, isNullable: false, isUnique: true, defaultValue: 'gen_random_uuid()' }],
      }])
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-lg p-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Supabase Schema Generator</h1>
