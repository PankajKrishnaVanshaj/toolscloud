    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="mt-6 bg-gray-50 p-4 rounded-lg">
          <h2 className="text-lg font-semibold mb-2">About RGB to HEX Conversion</h2>
          <div className="text-sm text-gray-700">
            <p>Converts RGB (screen color model) to HEX (web color format):</p>
            ...
            <p className="mt-1">Adjust RGB values to see the corresponding HEX and HSL output.</p>
          </div>
        </div>
      </div>
    </div>
