// components/TimescaleDBSchemaGenerator.jsx
'use client'
  ...
  const [tables, setTables] = useState([
    {
      ...
      partitionColumn: '',
      columns: [
        { name: 'id', type: 'BIGINT', isPrimary: true, isNullable: false, isUnique: true, defaultValue: '' },
        { name: 'timestamp', type: 'TIMESTAMPTZ', isPrimary: false, isNullable: false, isUnique: false, defaultValue: 'NOW()' },
        { name: 'value', type: 'DOUBLE PRECISION', isPrimary: false, isNullable: false, isUnique: false, defaultValue: '' },
        { name: 'sensor_id', type: 'VARCHAR(50)', isPrimary: false, isNullable: false, isUnique: false, defaultValue: '' },
      ],
    },
  ])
  ...
  const addTable = () => {
    if (tables.length < MAX_TABLES) {
      setTables([...tables, {
        ...
        timeColumn: '',
        partitionColumn: '',
        columns: [{ name: 'id', type: 'BIGINT', isPrimary: true, isNullable: false, isUnique: true, defaultValue: '' }],
      }])
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-lg p-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">TimescaleDB Schema Generator</h1>
