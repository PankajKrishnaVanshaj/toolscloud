export default  {
    title: "Text to Number Converter | Convert Letters to Numbers Online",
    description:
    ...
    target_audience: "Students, Developers, Teachers, Cryptography Enthusiasts",
    ...
    twitter: {
      ...
      title: "Text to Number | Convert Letters to Numbers Online",
      description:
        "Instantly change A-Z letters to 1-26 numeric values using this free online Text to Number Converter. Useful for cryptography and learning tools.",
      image: "https://toolscloud.pankri.com/appicons/toolscloud.png",
      creator: "@pankri",
    },
